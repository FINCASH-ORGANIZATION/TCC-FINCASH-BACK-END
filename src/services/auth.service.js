...
export const loginService = (email) => Usuario.findOne({ email: email }).select("+senha");
...
export const geradorToken = (id) => jwt.sign({ id: id }, process.env.CHAVE_JWT, {expiresIn: 172800});